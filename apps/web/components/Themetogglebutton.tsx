...
const defaultColors: ToggleColors = {
  dayBg: "#C2D1D1",      // Light Blue
  nightBg: "#5A403A",    // Dark Brown
  knobDay: "#E8E2D6",    // Beige (Sun)
  knobNight: "#C39A92",  // Dusty Rose (Moon)
  cloudDay: "#E8E2D6",   // Beige 
  cloudNight: "#856358", // Medium Brown
  stars: "#E8E2D6",      // Beige
  border: "#5A403A",     // Dark Brown
};
